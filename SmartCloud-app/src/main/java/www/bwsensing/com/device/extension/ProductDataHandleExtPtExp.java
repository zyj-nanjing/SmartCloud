...
public class ProductDataHandleExtPtExp implements ClientMessageHandleExtPt {
    ...
    public void getAndHandler(ClientMessageHandleCmd handleCmd) {
        ...
        List<ProductDataModel> dataModels = productModelGateway.getDataModelByWebId(streamData.getModelId());

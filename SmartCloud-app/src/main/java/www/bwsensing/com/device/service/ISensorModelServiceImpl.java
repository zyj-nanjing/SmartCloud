...
import www.bwsensing.com.device.command.SensorModelCmdExo;
import www.bwsensing.com.device.convertor.SensorModelCoConvertor;
...
@CatchAndLog
@Component
public class ISensorModelServiceImpl implements SensorModelService {
    @Resource

package www.bwsensing.com.common.interceptor.impl;

import org.springframework.stereotype.Component;
import www.bwsensing.com.common.annotation.RepeatSubmit;
import www.bwsensing.com.common.interceptor.RepeatSubmitInterceptor;
...
public class SameUrlDataInterceptor extends RepeatSubmitInterceptor
{
    ...
    public boolean isRepeatSubmit(HttpServletRequest request, RepeatSubmit annotation) throws Exception
    {
        ...
        Map<String, Object> nowDataMap = new HashMap<String, Object>(128);
        ...
        Map<String, Object> sessionMap = new HashMap<String, Object>(8);

...
import www.bwsensing.com.system.convertor.DeptTemplateConvertor;
import www.bwsensing.com.system.convertor.StructureTemplateConvertor;
...
import www.bwsensing.com.system.gatewayimpl.database.StructureTemplateMapper;
...
public class StructureTemplateGatewayImpl implements SysStructureTemplateGateway {
    ...
    private void validDepartment(SystemDeptTemplate deptTemplate){
        if(null != deptTemplate.getParentId()){
            Assert.isTrue((null!=deptTemplateMapper.getDeptTemplateById(deptTemplate.getParentId())),"VALID_ERROR","父节点不存在!");
        }
    }
